...
const searchedIngredients = computed(() => { 
    if (!searchedIngredients) return ingredients
...
<template>
    <div class="p-8 pb-0 text-orange-500">
        <h1 class="text-4xl font-bold mb-4">Search Meals by Ingredient</h1>
    </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-4 gap-5">
            <router-link v-for="ingredient in searchedIngredients" 
